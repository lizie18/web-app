...
export const loadAllCustomers = createAction('[Customers revolver] Load All Customers');

export const loadAllCustomersSucces = createAction(
  '[Load Customers Effects] All Customers Succes Load',
  props<{ customers: Customer[] }>()
);

export const createCustomer = createAction(
  '[Create Customer Component] Create Customer',
  props<{ customer: Customer }>()
);
